...
if ($ValidateMarkdownHelp)
{
    ...
    Test-SecMgmtMarkdownHelp "$PSScriptRoot\..\docs\help" $SuppressedExceptionsPath $NewExceptionsPath
...
if ($GenerateMamlHelp)
{
    New-SecMgmtMamlHelp -HelpFolderPath "$PSScriptRoot\..\docs\help" -OutputPath "$PSScriptRoot\..\artifacts\$BuildConfig"
}