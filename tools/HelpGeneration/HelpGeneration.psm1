...
function New-SecMgmtMarkdownHelp
{
    [CmdletBinding()]
    Param
    (
    ...
    $psd1 = Get-ChildItem $ModuleFolderPath | where { $_.Name -eq "SecMgmt.psd1" }
    ...
    $errors = Compare-SecMgmtMarkdownHelp $HelpFolderPath $NewHelpFolderPath
...
function Compare-SecMgmtMarkdownHelp
{
    [CmdletBinding()]
    Param
    (
...
function Test-SecMgmtMarkdownHelp
{
    [CmdletBinding()]
    Param(
        [Parameter(Mandatory = $true, Position = 0)]
...
function New-SecMgmtMamlHelp
{
    ...
    $MAML | foreach { Edit-SecMgmtMamlHelp $_ }
}

function Edit-SecMgmtMamlHelp
{
    [CmdletBinding()]
    Param
    (
