...
namespace Microsoft.Online.SecMgmt.PowerShell.Network
{
    ...
    public class GraphAuthenticationProvider : IAuthenticationProvider
    {
        ...
        public async Task AuthenticateRequestAsync(HttpRequestMessage request)
        {
            ...
            MgmtAccount account = MgmtSession.Instance.Context.Account.Clone();
            ...
            AuthenticationResult authResult = await MgmtSession.Instance.AuthenticationFactory.AuthenticateAsync(
                account,
                MgmtSession.Instance.Context.Environment,
                new[] { $"{MgmtSession.Instance.Context.Environment.GraphEndpoint}/.default" }).ConfigureAwait(false);
