...
namespace Microsoft.Online.SecMgmt.PowerShell.Models.Errors
{
    using System;
    ...
    /// </summary>
    public class MgmtExceptionRecord : MgmtErrorRecord
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MgmtExceptionRecord"/>
        /// </summary>
        /// <param name="exception">The error that occur during command execution.</param>
        /// <param name="record">The record of the error.</param>
        public MgmtExceptionRecord(Exception exception, ErrorRecord record) :
            base(record)
        {
            if (exception != null)
            {
