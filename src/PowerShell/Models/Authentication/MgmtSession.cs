...
namespace Microsoft.Online.SecMgmt.PowerShell.Models.Authentication
{
    ...
    /// </summary>
    public sealed class MgmtSession
    {
        /// <summary>
        ...
        /// <summary>
        /// Singleton instance of the <see cref="MgmtSession" /> class.
        /// </summary>
        private static readonly Lazy<MgmtSession> mgmtSession = new Lazy<MgmtSession>();
        ...
        /// </summary>
        public MgmtContext Context { get; set; }
        ...
        /// <summary>
        /// Gets an instance of the <see cref="MgmtSession" /> class.
        /// </summary>
        public static MgmtSession Instance
        {
            get
            {
