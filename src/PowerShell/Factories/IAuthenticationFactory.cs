...
namespace Microsoft.Online.SecMgmt.PowerShell.Factories
{
    ...
    public interface IAuthenticationFactory
    {
        ...
        Task<AuthenticationResult> AuthenticateAsync(MgmtAccount account, MgmtEnvironment environment, IEnumerable<string> scopes, string message = null, CancellationToken cancellationToken = default);
    }
}