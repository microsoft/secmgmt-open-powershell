...
namespace Microsoft.Online.SecMgmt.PowerShell.Commands
{
    ...
    public abstract class MgmtPSCmdlet : PSCmdlet, IDisposable
    {
        ...
        protected override void BeginProcessing()
        {
            ...
            httpTracingInterceptor ??= new RecordingTracingInterceptor(MgmtSession.Instance.DebugMessages);
        ...
        {
            while (MgmtSession.Instance.DebugMessages.TryDequeue(out string message))
            {
                WriteDebug(message);
            }
        }
